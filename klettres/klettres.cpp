...
KLettres::KLettres(QWidget *parent, const char *name) : KMainWindow(parent, name)
{
   ...
   //Settings->Choose Language menu
	...
	language_list.append(i18n("French"));
